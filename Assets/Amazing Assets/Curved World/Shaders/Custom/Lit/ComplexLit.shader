...
Shader "Amazing Assets/Curved World/Complex Lit"
{
    Properties
    {
        [CurvedWorldBendSettings] _CurvedWorldBendSettings("0,1,2,3|1|1", Vector) = (0, 0, 0, 0)
...
#pragma shader_feature_local CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_POSITIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_NEGATIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_Z_NEGATIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_Z_POSITIVE
